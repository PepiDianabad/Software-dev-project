...
(1, 1, 'Succesfull'),
(2, 1, 'Quite successful'),
(3, 1, 'Not really successful'),
(4, 1, 'Failing'),
(5, 1, 'Repeating the class');
INSERT INTO "COMPANY" (ID, VERSION, NAME) VALUES
(6, 1, 'Technological School electronic systems'),
(7, 1, 'National Mathematics school'),
(8, 1, 'National school for architecture'),
(9, 1, 'Sofia Mathematical school'),
(10, 1, 'Second German school');
